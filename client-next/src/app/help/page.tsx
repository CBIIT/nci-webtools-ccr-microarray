  ...
  return (
    <section className="content-board">
      ...
      <ol>
        ...
        <li>
          <p>
            ...
            by providing the relevant series ID from the experiment, as noted below. Enter the
            entire ID, starting with GSE. Samples from different chips cannot be analyzed together.
            If the series ID contains samples from multiple chips, choose the type of chip from the
            drop-down menu. Samples analyzed on each chip will populate as the chip is chosen:
          </p>
          <video preload="metadata" controls>
      ...
      <p>
        ...
        <a href="https://www.bioconductor.org/packages/release/bioc/vignettes/oligo/inst/doc/oug.pdf" target="_blank" rel="noopener noreferrer">
      ...
      <p>
        Find the section{" "}
        <a href="#manualGroups"><b>Analysis/Manually Add Groups and Batches</b></a>{" "}
      ...
      <p>
        ...
        <a href="https://www.bioconductor.org/packages/release/bioc/vignettes/limma/inst/doc/usersguide.pdf" target="_blank" rel="noopener noreferrer">
      ...
      <p>
        ...
        <a href="https://github.com/CCBR/l2p" target="_blank" rel="noopener noreferrer">
      ...
      <p>
        ...
        MSigDB{" "}
        <a href="http://software.broadinstitute.org/gsea/msigdb/collections.jsp" target="_blank" rel="noopener noreferrer">
          (http://software.broadinstitute.org/gsea/msigdb/collections.jsp)
        </a>
        , and mouse gene set modules were downloaded from the Gene Set Knowledgebase{" "}
        <a href="https://www.bioconductor.org/packages/release/data/experiment/vignettes/gskb/inst/doc/gskb.pdf" target="_blank" rel="noopener noreferrer">
