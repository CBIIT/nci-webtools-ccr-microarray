...
class DEGBox extends Component {
    ...
    render() {
        ...
        let tabs = [<div key="deg_tag1" id="deg_tag1" className="deg_plot">
                        <DEGTable exportNormalAll={this.props.exportNormalAll} exportDEG={this.props.exportDEG} changeDeg={this.props.changeDeg} data={this.props.data} getDEG={this.props.getDEG} />
                   </div>,
            <div key="deg_tag2_pathway_up" id="deg_tag2" className="deg_plot hide" ><PUGTable exportNormalAll={this.props.exportNormalAll} exportPathwayUp={this.props.exportPathwayUp} changeLoadingStatus={this.props.changeLoadingStatus} changePathways_up={this.props.changePathways_up} data={this.props.data}  getPathwayUp={this.props.getPathwayUp}/></div>,
            <div key="deg_tag3_pathway_down" id="deg_tag3" className="deg_plot hide"><PDGTable exportNormalAll={this.props.exportNormalAll} exportPathwayDown={this.props.exportPathwayDown}  changeLoadingStatus={this.props.changeLoadingStatus} changePathways_down={this.props.changePathways_down} data={this.props.data}  getPathwayDown={this.props.getPathwayDown} /></div>,
        ...
        let content = [ <label key="label-deg_select_option" htmlFor="deg_select_option"><span key="deg_select_option_title">DEG section selection </span></label>,
                    <select   key="deg_select" className="ant-select-selection ant-select-selection--single" id="deg_select_option" defaultValue="deg_tag1" onChange={this.handleSelectionChange}>
