  ...
  render() {
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_symbol">
              ...
              <Input
                ...
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_symbol == ''
                    ? 'SYMBOL'
                    : this.props.data.diff_expr_genes.search_keyword.search_symbol
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'SYMBOL' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('SYMBOL', 'ascend')}
                  >
                ...
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'SYMBOL' &&
                        this.props.data.diff_expr_genes.sorting.order == 'descend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('SYMBOL', 'descend')}
                  >
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_fc">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_fc == ''
                    ? 'FC'
                    : this.props.data.diff_expr_genes.search_keyword.search_fc
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'FC' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('FC', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('FC', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_dge_search_p_value">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_p_value == ''
                    ? 'P.Value'
                    : this.props.data.diff_expr_genes.search_keyword.search_p_value
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'P.Value' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('P.Value', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('P.Value', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_adj_p_value">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_adj_p_value == ''
                    ? 'adj.P.Val'
                    : this.props.data.diff_expr_genes.search_keyword.search_adj_p_value
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'adj.P.Val' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('adj.P.Val', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('adj.P.Val', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_aveexpr">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_aveexpr == ''
                    ? 'AveExpr'
                    : this.props.data.diff_expr_genes.search_keyword.search_aveexpr
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'AveExpr' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('AveExpr', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('AveExpr', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_input_deg_search_accnum">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_accnum == ''
                    ? 'ACCNUM'
                    : this.props.data.diff_expr_genes.search_keyword.search_accnum
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'ACCNUM' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('ACCNUM', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('ACCNUM', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_desc">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_desc == ''
                    ? 'DESC'
                    : this.props.data.diff_expr_genes.search_keyword.search_desc
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'DESC' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('DESC', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('DESC', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_entrez">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_entrez == ''
                    ? 'ENTREZ'
                    : this.props.data.diff_expr_genes.search_keyword.search_entrez
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'ENTREZ' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('ENTREZ', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('ENTREZ', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_probsetid">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_probsetid == ''
                    ? 'probsetID'
                    : this.props.data.diff_expr_genes.search_keyword.search_probsetid
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'probsetID' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('probsetID', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('probsetID', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_t">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_t == ''
                    ? 't'
                    : this.props.data.diff_expr_genes.search_keyword.search_t
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 't' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('t', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_deg_search_b">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.diff_expr_genes.search_keyword.search_b == ''
                    ? 'b'
                    : this.props.data.diff_expr_genes.search_keyword.search_b
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.diff_expr_genes.sorting.name == 'b' &&
                        this.props.data.diff_expr_genes.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('b', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
    ...
    content = (
      <div>
        <div>
          {' '}
          <p className="err-message" id="message-deg"></p>
        </div>
        ...
        <div id="deg-select">
          ...
          &nbsp;of total {this.props.data.diff_expr_genes.pagination.total} records
        </div>
        <div>
          <Table
            columns={columns}
