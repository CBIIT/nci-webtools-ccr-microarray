  ...
  render() {
          ...
          <div className="pathway_up_pathways_id_head">
            <label htmlFor="input_pathway_up_search_PATHWAY_ID">
              ...
              <Input
                ...
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_PATHWAY_ID == ''
                    ? 'PATHWAY_ID'
                    : this.props.data.pathways_up.search_keyword.search_PATHWAY_ID
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Pathway_ID' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                ...
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Pathway_ID' &&
                        this.props.data.pathways_up.sorting.order == 'descend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_source_head">
            <label htmlFor="input_pathway_up_search_SOURCE">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_SOURCE == ''
                    ? 'SOURCE'
                    : this.props.data.pathways_up.search_keyword.search_SOURCE
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Source' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_desc_head">
            <label htmlFor="input_pathway_up_search_DESCRIPTION">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_DESCRIPTION == ''
                    ? 'DESC'
                    : this.props.data.pathways_up.search_keyword.search_DESCRIPTION
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Description' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_type_head">
            <label htmlFor="input_pathway_up_search_TYPE">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_TYPE == ''
                    ? 'TYPE'
                    : this.props.data.pathways_up.search_keyword.search_TYPE
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Type' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_p_value_head">
            <label htmlFor="input_pathway_up_search_p_value">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_p_value == ''
                    ? 'P_Value'
                    : this.props.data.pathways_up.search_keyword.search_p_value
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'P_Value' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_fdr_head">
            <label htmlFor="input_pathway_up_search_fdr">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_fdr == ''
                    ? 'FDR'
                    : this.props.data.pathways_up.search_keyword.search_fdr
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'FDR' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_ratio_head">
            <label htmlFor="input_pathway_up_search_RATIO">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_RATIO == ''
                    ? 'RATIO'
                    : this.props.data.pathways_up.search_keyword.search_RATIO
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Ratio' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_gene_list_head">
            <label htmlFor="input_pathway_up_search_GENE_LIST">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_GENE_LIST == ''
                    ? 'GENE_LIST'
                    : this.props.data.pathways_up.search_keyword.search_GENE_LIST
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'GENE_LIST' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_number_hits_head">
            <label htmlFor="input_pathway_up_search_NUMBER_HITS">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_NUMBER_HITS == ''
                    ? 'HITS'
                    : this.props.data.pathways_up.search_keyword.search_NUMBER_HITS
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Number_Hits' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_number_genes_pathway_head">
            <label htmlFor="input_pathway_up_search_NUMBER_GENES_PATHWAY">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_NUMBER_GENES_PATHWAY == ''
                    ? 'GENES_PATHWAY'
                    : this.props.data.pathways_up.search_keyword.search_NUMBER_GENES_PATHWAY
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Number_Genes_Pathway' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_number_user_genes_head">
            <label htmlFor="input_pathway_up_search_NUMBER_USER_GENES">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_NUMBER_USER_GENES == ''
                    ? 'USER_GENES'
                    : this.props.data.pathways_up.search_keyword.search_NUMBER_USER_GENES
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Number_User_Genes' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div className="pathway_up_total_number_genes_head">
            <label htmlFor="input_pathway_up_search_TOTAL_NUMBER_GENES">
              ...
              <Input
                ...
                placeholder="GENES"
                placeholder={
                  this.props.data.pathways_up.search_keyword.search_TOTAL_NUMBER_GENES == ''
                    ? 'GENES'
                    : this.props.data.pathways_up.search_keyword.search_TOTAL_NUMBER_GENES
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.pathways_up.sorting.name == 'Total_Number_Genes' &&
                        this.props.data.pathways_up.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
    ...
    content = (
      <div>
        <div>
          {' '}
          <p className="err-message" id="message-pug"></p>
        </div>
        ...
        <div id="pathways-up-select">
          ...
          &nbsp;of total {this.props.data.pathways_up.pagination.total} records
        </div>
