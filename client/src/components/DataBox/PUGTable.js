                  ...
                  <div> <p className="err-message" id="message-pug"></p></div>  
                   <div  className="div-export-pathwayUp"><Button   id="btn-pathwayUp-export"   type="primary" onClick={this.props.exportPathwayUp}> Export</Button> </div>
                     ...
                     <div className="row" style={{"paddingLeft": "10px","paddingTop": "5px","paddingBottom": "0px"}}>
                           ...
                           <div className="filter_col"  style={{width:"8%"}}><label for="input_pathway_up_search_p_value"><span style={{display:"none"}}>input_pathway_up_search_p_value</span><Input onPressEnter={value=>search(value) }    placeholder={this.props.data.pathways_up.search_keyword.search_p_value}  id="input_pathway_up_search_p_value"/></label></div>
