...
class PostPlotsBox extends Component {
    ...
    render() {
        ...
        let content = [<label for="post-normalization-plots-selection">Select Post-Normalization QC Plots</label>,<select  id="post-normalization-plots-selection"className="ant-select-selection ant-select-selection--single" key="select_post_tag2" defaultValue="postHistogram" style={{ width: 240 }} onChange={this.handleSelectionChange}>
