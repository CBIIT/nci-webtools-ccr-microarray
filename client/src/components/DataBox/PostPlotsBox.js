...
// HistplotBN,MAplotBN,BoxplotBN,RLEplotBN,NUSEplotBN,HistplotAN,MAplotAN,BoxplotAN,PCA,Heatmapolt,time_cost
 ...
 render() {
    ...
    var PCAIframe = <div><iframe src={"http://localhost:9000/images/"+this.props.data.projectID+this.props.data.PCA}  width={'100%'} height={'100%'} frameBorder={'0'}/></div>
    ...
    var maplot_style = 	{
 	...
 	let tabs =[ <div id="post_tag1" className="plot">
  	...
  	let content = [<Select defaultValue="post_tag1" style={{ width: 240 }} onChange={this.handleSelectionChange}>
