...
class PostPlotsBox extends Component {
    ...
    render() {
        ...
        let tabs = [
            <div id="postHistogram" key="post_tag1" className="plot2" > { this.props.data.postplot.histplotAN } </div>,
            <div id="postMAplots" key="post_tag2"  className="plot2 hide"  > { this.props.data.postplot.list_mAplotAN } </div>,
            <div id="postBoxplots" key="post_tag3"  className="plot2 hide"> {this.props.data.postplot.Boxplots}</div>,
            <div id="postPCA" key="post_tag4"  className="plot2 hide"> {this.props.data.postplot.PCA} </div>,
            <div id="postHeatmap" key="post_tag5"  className="plot2 hide"> {this.props.data.postplot.Heatmapolt} </div>
        ]
