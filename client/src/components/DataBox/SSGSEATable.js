...
class SSGSEATable extends Component {
  ...
  handleMenuClick = e => {
    ...
    this.props.getssGSEA({
      ...
      search_keyword: this.props.data.ssGSEA.search_keywordƒ
    });
  };
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor={'input_ssg_name'}>
              ...
              <Input
                ...
                placeholder={
                  this.props.data.ssGSEA.search_keyword.name == ''
                    ? 'NAME'
                    : this.props.data.ssGSEA.search_keyword.name
                }
                id="input_ssg_name"
                defaultValue={this.props.data.ssGSEA.search_keyword.name}
              />
            </label>
            <div>
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.ssGSEA.sorting.name == 'NAME' &&
                        this.props.data.ssGSEA.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('NAME', 'ascend')}
                  >
                ...
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.ssGSEA.sorting.name == 'NAME' &&
                        this.props.data.ssGSEA.sorting.order == 'descend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('NAME', 'descend')}
                  >
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_ssg_search_logFC">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.ssGSEA.search_keyword.search_logFC == ''
                    ? 'logFC'
                    : this.props.data.ssGSEA.search_keyword.search_logFC
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.ssGSEA.sorting.name == 'logFC' &&
                        this.props.data.ssGSEA.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('logFC', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('logFC', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_ssg_search_p_value">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.ssGSEA.search_keyword.search_p_value == ''
                    ? 'P.Value'
                    : this.props.data.ssGSEA.search_keyword.search_p_value
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.ssGSEA.sorting.name == 'P.Value' &&
                        this.props.data.ssGSEA.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_ssg_search_adj_p_value">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.ssGSEA.search_keyword.search_adj_p_value == ''
                    ? 'adj.P.Value'
                    : this.props.data.ssGSEA.search_keyword.search_adj_p_value
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.ssGSEA.sorting.name == 'adj.P.Val' &&
                        this.props.data.ssGSEA.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div style={{ textAlign: 'center', width: '230px' }}>
            <label htmlFor="input_ssg_search_Avg_Enrichment_Score">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.ssGSEA.search_keyword.search_Avg_Enrichment_Score == ''
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.ssGSEA.sorting.name == 'Avg.Enrichment.Score' &&
                        this.props.data.ssGSEA.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
                    onClick={() => this.sorter('Avg.Enrichment.Score', 'ascend')}
                  >
                    <i className="fas fa-angle-up"></i>
                  </a>
                </div>
                <div>
                  <a
                    ...
                    onClick={() => this.sorter('Avg.Enrichment.Score', 'descend')}
                  >
                    <i className="fas fa-angle-down"></i>
                  </a>
                </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_ssg_search_t">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.ssGSEA.search_keyword.search_t == ''
                    ? 't'
                    : this.props.data.ssGSEA.search_keyword.search_t
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.ssGSEA.sorting.name == 't' &&
                        this.props.data.ssGSEA.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
          ...
          <div style={{ textAlign: 'center' }}>
            <label htmlFor="input_ssg_search_b">
              ...
              <Input
                ...
                onPressEnter={value => search(value)}
                placeholder={
                  this.props.data.ssGSEA.search_keyword.search_b == ''
                    ? 'B'
                    : this.props.data.ssGSEA.search_keyword.search_b
                }
              ...
              <div className="head-sorter">
                <div>
                  <a
                    style={{
                      color:
                        this.props.data.ssGSEA.sorting.name == 'B' &&
                        this.props.data.ssGSEA.sorting.order == 'ascend'
                          ? 'blue'
                          : '#ccc'
                    }}
    ...
    let tabs = [
      ...
      >
        ...
        <div className="div-export-ss">
          <Button id="btn-ss-export" type="primary" onClick={this.props.exportGSEA}>
            {' '}
            Export
          </Button>
        </div>
        <div id="ss-select">
          ...
          &nbsp; of total {this.props.data.ssGSEA.pagination.total} records
        </div>
        <div>
          <Table
            columns={columns}
