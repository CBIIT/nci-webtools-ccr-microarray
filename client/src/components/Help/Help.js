    ...
    return (
      <div className="container container-board">
        <section>
          ...
          <div>
            <p>
              MicroArray Analysis Pipeline (MAAPster) is a comprehensive web tool designed by the
              CCR Collaborative Bioinformatics Resource (CCBR) that performs transcriptome analysis
              of human or mouse Affymetrix gene expression data. Samples may be uploaded locally or
              pulled from publicly available data by entering a GEO Series identification number.
              MAAPster is able to analyze data from a single experiment, or GEO Series, and allows
              for the investigation of multiple contrasts between groups of samples. Raw CEL files
              are analyzed using several Bioconductor packages in ‘R’, including limma, oligo, and
              gsva (Carvalho & Irizarry, 2010; Hanzelmann, Castelo, & Guinney, 2013; Ritchie et al.,
              2015). Output includes quality control plots, normalized gene expression data,
              differential gene expression analysis, gene expression heatmaps, pathway analysis and
          ...
          <ul>
            <li>
              <p>
                ...
                must be expression data in CEL file format, and all data must be from the same type
                of Affymetrix chip.
              </p>
              <p>
                <video
                  src="./assets/img/loading-upload-file.webm"
                  type="video/webm"
                  autoplay="true"
                  loop
                  controls
            ...
            <li>
              ...
              <p>
                <video
                  src="./assets/img/loading-with-accession-data.webm"
                  type="video/webm"
                  autoplay="true"
                  loop
                  controls
          ...
          <p>
            <video src="./assets/img/group.webm" type="video/webm" autoplay="true" loop controls>
              Sorry, your browser doesn't support embedded videos.
            </video>
          </p>
          ...
          <p>
            Two plots, NUSE and RLE, display quality control metrics for the microarray probes.
            Plots are created with the oligo package:
          </p>
          <ul>
            <li>
              <p>
                The Normalized Unscaled Standard Error (NUSE) plot shows standard error estimates
                for each sample. These estimates are normalized to 1 across all samples, so a sample
                with a significantly higher value may be of lower quality (Carvalho & Irizarry,
                2010).{' '}
              </p>
              <p>
                <video src="./assets/img/nuse.webm" type="video/webm" autoplay="true" loop controls>
                  Sorry, your browser doesn't support embedded videos.
                </video>
              </p>
            </li>
            <li>
              ...
              <p>
                <video src="./assets/img/RLE.webm" type="video/webm" autoplay="true" loop controls>
                  Sorry, your browser doesn't support embedded videos.
                </video>
              </p>
            </li>
          ...
          <p>
            ...
            Averaging (RMA) method described in (Irizarry et al., 2003). Optional cyclic loess is
            also available and can be performed if RMA is insufficient (Ballman, Grill, Oberg, &
            Therneau, 2004; Bolstad, Irizarry, Astrand, & Speed, 2003). All samples are used for
            normalization regardless of group selections. Pre-normalization and post-normalization
            histograms, MA plots and box plots display relative expression (represented by probe
            intensity) before and after RMA. Data for the plots are generated with the oligo package
            (Carvalho & Irizarry, 2010). Normalized data can be downloaded in the DEG-Enrichments
            Results tab.
          </p>
          <p>
            Histogram: The histogram displays the density of probes at each log-intensity. Each
            sample is represented by a curved line. Before RMA, samples should be distributed
            ...
            investigated further before downstream analyses. After RMA, all samples lines should
            follow the same curve. Again, if samples are clustered into groups, batch effects may be
            present.
          </p>
          <p>
            <video
              src="./assets/img/histogram.webm"
              type="video/webm"
              autoplay="true"
              loop
              controls
          ...
          <p>
            ...
            generated that compare each sample to the median of all samples. After RMA, the red
            sample line should be relatively equal to the blue median line.
          </p>
          <p>
            <video src="./assets/img/MAplot.webm" type="video/webm" autoplay="true" loop controls>
              Sorry, your browser doesn't support embedded videos.
            </video>
          </p>
          ...
          <p>
            <video src="./assets/img/boxplot.webm" type="video/webm" autoplay="true" loop controls>
              Sorry, your browser doesn't support embedded videos.
            </video>
          </p>
          ...
          <p>
            Two plots, the sample similarity heatmap and 3D PCA, provide information about the
            quality of replicates in the groups. In general, samples in the same group should
            cluster together, and groups of samples should cluster separately from other groups.{' '}
          </p>
          <h4>3D PCA:</h4>
          <p>
            <video src="./assets/img/PCA.webm" type="video/webm" autoplay="true" loop controls>
              Sorry, your browser doesn't support embedded videos.
            </video>
          </p>
          ...
          <p>
            <video src="./assets/img/heatmap.webm" type="video/webm" autoplay="true" loop controls>
              Sorry, your browser doesn't support embedded videos.
            </video>
          </p>
          ...
          <p>
            After normalization, determine differential gene expression between groups. MAAPster
            runs analysis in the background with the limma package. Linear modeling is performed
            using limma’s lmFit function, and differential gene expression is determined using the
          ...
          <p>
            <video src="./assets/img/deg.webm" type="video/webm" autoplay="true" loop controls>
              Sorry, your browser doesn't support embedded videos.
            </video>
          </p>
          ...
          <p>
            <video src="./assets/img/pathway.webm" type="video/webm" autoplay="true" loop controls>
              Sorry, your browser doesn't support embedded videos.
            </video>
          </p>
          ...
          <p>
            ...
            Pathway enrichment scores are then analyzed to determine fold changes and p-values
            between groups of samples, similar to the differential gene expression analysis
            described above. Differential pathway enrichment is ranked by p-value, and the top 50
            pathways are displayed in a heatmap. Human gene set modules were downloaded from the
          ...
          <p>
            <video src="./assets/img/ssGSEA.webm" type="video/webm" autoplay="true" loop controls>
              Sorry, your browser doesn't support embedded videos.
            </video>
          </p>
          ...
          <ul>
            ...
            <li>
              Hanzelmann, S., Castelo, R., & Guinney, J. (2013). GSVA: gene set variation analysis
              for microarray and RNA-seq data. BMC Bioinformatics, 14, 7. doi:10.1186/1471-2105-14-7
            </li>
            <li>
