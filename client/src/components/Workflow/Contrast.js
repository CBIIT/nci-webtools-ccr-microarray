...
class Contrast extends Component {
    ...
    render() {
        ...
        let normalization_option = (<select id="select-normal" className="ant-select-selection ant-select-selection--single" style={{ width: "100%" }} value={this.props.data.normal}  onChange={this.props.handleNormalSelect}>
        ...
        if (options.length <= 1) {
            ...
            content =
              ...
              <div className="block ">
               <label className="title" htmlFor="select-group-1">Choose QCnorm:</label>
