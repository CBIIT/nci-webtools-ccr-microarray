    ...
    render() {
        ...
        let queueBlock = <div className="block ">
              <div  id="checkbox_queue">  <Checkbox checked={this.props.data.useQueue} onChange={this.handleSwitchChange} >Submit this job to a Queue</Checkbox></div>
               <div class="queueMessage" style={{"paddingLeft":"23px"}}>(Jobs currently enquued: {this.props.data.numberOfTasksInQueue})</div>
             ...
             <span class="queueMessage">Note: if sending to queue, when computation is completed, a notification will be sent to the e-mail entered above.</span>
