options(repos = c(CRAN = "https://packagemanager.posit.co/cran/__linux__/rhel9/latest"), Ncpus = parallel::detectCores())

install.packages(
    c(
        "remotes", "jsonlite", "gplots", "rglwidget", "DT", "getopt", "knitr",
...
BiocManager::install(
    c(
        "Biobase", "GEOquery", "GSEABase", "GSVA", "annotate", "sva",
        ...
        "clariomsrattranscriptcluster.db", "hgu133a.db", "hgu133a2.db",
